Shader "NatureManufacture Shaders/Ice Lake/Ice Shader Specular Lake"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandardSpecular o )
		{
			...
			float eyeDepth346 = LinearEyeDepth(UNITY_SAMPLE_DEPTH(tex2Dproj(_CameraDepthTexture,UNITY_PROJ_COORD(ase_screenPos))));
			...
			half4 screenColor305 = tex2D( GrabScreen1, ( (ase_screenPosNorm).xy + (( tex2DNode17 * _RefractionPower )).xy ) );
