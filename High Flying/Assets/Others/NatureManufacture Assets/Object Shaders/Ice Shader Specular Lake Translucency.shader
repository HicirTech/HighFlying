Shader "NatureManufacture Shaders/Ice Lake/Ice Shader Specular Lake Translucency"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandardSpecularCustom o )
		{
			...
			float eyeDepth355 = LinearEyeDepth(UNITY_SAMPLE_DEPTH(tex2Dproj(_CameraDepthTexture,UNITY_PROJ_COORD(ase_screenPos))));
			...
			half4 screenColor305 = tex2D( _GrabScreen1, ( (ase_screenPosNorm).xy + (( tex2DNode17 * _RefractionPower )).xy ) );
			...
			float4 lerpResult294 = lerp( lerpResult93 , _RefractionColor , clampResult299);
			o.Albedo = lerpResult294.rgb;
			float3 temp_cast_3 = (_SpecularPower).xxx;
