Shader "NatureManufacture Shaders/Standard Shaders/Standard Metalic UV Free"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float3 temp_output_3608_0 = BlendNormals( tanTriplanarNormal3667 , UnpackScaleNormal( tex2D( _ShapeBumpMap, uv_ShapeBumpMap ) ,_ShapeBumpMapScale ) );
			float2 uv_DetailAlbedoMap = i.uv_texcoord * _DetailAlbedoMap_ST.xy + _DetailAlbedoMap_ST.zw;
			float2 uv_DetailMask = i.uv_texcoord * _DetailMask_ST.xy + _DetailMask_ST.zw;
			float4 tex2DNode3685 = tex2D( _DetailMask, uv_DetailMask );
			float3 lerpResult3687 = lerp( temp_output_3608_0 , BlendNormals( temp_output_3608_0 , UnpackScaleNormal( tex2D( _DetailNormalMap, uv_DetailAlbedoMap ) ,_DetailNormalMapScale ) ) , tex2DNode3685.a);
			...
			float4 blendOpDest3683 = ( _DetailAlbedoPower * tex2D( _DetailAlbedoMap, uv_DetailAlbedoMap ) );
			...
			float clampResult3617 = clamp( tex2D( _ShapeAmbientOcclusionG, uv_ShapeBumpMap ).g , ( 1.0 - _ShapeAmbientOcclusionPower ) , 1.0 );
