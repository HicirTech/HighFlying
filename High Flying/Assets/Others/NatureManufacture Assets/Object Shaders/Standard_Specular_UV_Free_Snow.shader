...
Shader "NatureManufacture Shaders/Standard Shaders/Standard Specular UV Free Snow"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandardSpecular o )
		{
			...
			float3 lerpResult3793 = lerp( tanTriplanarNormal3771 , BlendNormals( tanTriplanarNormal3771 , UnpackScaleNormal( tex2D( _DetailNormalMap, uv_DetailAlbedoMap ) ,_DetailNormalMapScale ) ) , tex2DNode3795.a);
			...
			float3 lerpResult3676 = lerp( BlendNormals( UnpackScaleNormal( tex2D( _ShapeBumpMap, uv_ShapeBumpMap ) ,_ShapeBumpScale ) , lerpResult3793 ) , ( tanTriplanarNormal3778 * appendResult3779 ) , ( saturate( ( ase_worldNormal.y * _Snow_Amount ) ) * temp_output_3673_0 ));
			...
			float4 blendOpDest3786 = ( _DetailAlbedoPower * tex2D( _DetailAlbedoMap, uv_DetailAlbedoMap ) );
			...
			float temp_output_3682_0 = saturate( ( ( WorldNormalVector( i , lerpResult3676 ).y * _Snow_Amount ) * ( ( _Snow_Amount * _SnowHardness ) * temp_output_3673_0 ) ) );
			float4 lerpResult3317 = lerp( lerpResult3794 , ( triplanar3776 * _SnowColor ) , temp_output_3682_0);
			...
			float3 lerpResult3332 = lerp( ( _SpecularPower * appendResult3389 ) , ( appendResult3467 * _SnowSpecularPower ) , temp_output_3682_0);
			o.Specular = lerpResult3332;
			float lerpResult3345 = lerp( ( break3388.w * _SmoothnessPower ) , ( break3454.w * _SnowSmoothnessPower ) , temp_output_3682_0);
			o.Smoothness = lerpResult3345;
			float clampResult3626 = clamp( tex2D( _ShapeAmbientOcclusionG, uv_ShapeBumpMap ).g , ( 1.0 - _ShapeAmbientOcclusionPower ) , 1.0 );
