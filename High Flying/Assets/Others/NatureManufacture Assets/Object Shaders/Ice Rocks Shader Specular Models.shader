Shader "NatureManufacture Shaders/Ice/Ice Rocks Shader Specular Models"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandardSpecular o )
		{
			...
			float2 appendResult11_g1019 = (float2(tex2DNode17.a , tex2DNode17.g));
			float2 temp_output_4_0_g1019 = ( ( ( appendResult11_g1019 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _IceNormalScale * -1.0 ) );
			...
			float3 appendResult19_g1019 = (float3(break8_g1019.y , break8_g1019.x , temp_output_9_0_g1019));
			...
			float2 appendResult11_g1020 = (float2(tex2DNode342.a , tex2DNode342.g));
			float2 temp_output_4_0_g1020 = ( ( ( appendResult11_g1020 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _IceNormalScale );
			...
			float3 appendResult10_g1020 = (float3(break8_g1020.x , break8_g1020.y , temp_output_9_0_g1020));
			float3 appendResult307 = (float3(1.0 , ( ase_worldNormal.z * -1.0 ) , 1.0));
			float3 weightedBlendVar315 = BlendComponents288;
			float3 weightedAvg315 = ( ( weightedBlendVar315.x*( appendResult19_g1019 * appendResult308 ) + weightedBlendVar315.y*tanTriplanarNormal423 + weightedBlendVar315.z*( appendResult10_g1020 * appendResult307 ) )/( weightedBlendVar315.x + weightedBlendVar315.y + weightedBlendVar315.z ) );
