...
Shader "NatureManufacture Shaders/Standard Shaders/Standard Specular UV Free"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandardSpecular o )
		{
			...
			float3 normalizeResult3312 = normalize( BlendNormals( UnpackScaleNormal( tex2D( _ShapeBumpMap, uv_ShapeBumpMap ) ,_ShapeBumpScale ) , tanTriplanarNormal3719 ) );
			float2 uv_DetailAlbedoMap = i.uv_texcoord * _DetailAlbedoMap_ST.xy + _DetailAlbedoMap_ST.zw;
			float2 uv_DetailMask = i.uv_texcoord * _DetailMask_ST.xy + _DetailMask_ST.zw;
			float4 tex2DNode3732 = tex2D( _DetailMask, uv_DetailMask );
			float3 lerpResult3734 = lerp( normalizeResult3312 , BlendNormals( normalizeResult3312 , UnpackScaleNormal( tex2D( _DetailNormalMap, uv_DetailAlbedoMap ) ,_DetailNormalMapScale ) ) , tex2DNode3732.a);
			...
			float4 blendOpDest3730 = ( _DetailAlbedoPower * tex2D( _DetailAlbedoMap, uv_DetailAlbedoMap ) );
