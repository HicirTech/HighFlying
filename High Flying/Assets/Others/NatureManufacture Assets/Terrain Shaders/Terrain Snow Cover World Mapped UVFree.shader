Shader "NatureManufacture Shaders/Terrain/Terrain Snow Cover World MappedUVFree"
{
	Properties
	{
	...
	SubShader
	{
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			float4 temp_cast_0 = (localCalculateTangents203).xxxx;
				...
				float4 staticSwitch321 = float4(0,0,0,0);
			#else
				float4 staticSwitch321 = temp_cast_0;
			#endif
			v.vertex.xyz += staticSwitch321.xyz;
		}

		void surf( Input i , inout SurfaceOutputStandardSpecular o )
		{
			float temp_output_307_0 = ( 1.0 / _Texture1Tilling );
			float3 ase_worldPos = i.worldPos;
			float3 ase_worldNormal = WorldNormalVector( i, float3( 0, 0, 1 ) );
			float3 ase_worldTangent = WorldNormalVector( i, float3( 1, 0, 0 ) );
			float3 ase_worldBitangent = WorldNormalVector( i, float3( 0, 1, 0 ) );
			float3x3 ase_worldToTangent = float3x3( ase_worldTangent, ase_worldBitangent, ase_worldNormal );
			float3 triplanar314 = TriplanarSamplingSNF( _Normal0, ase_worldPos, ase_worldNormal, _TriplanarFallOff, temp_output_307_0, _Normal1Power, 0 );
			float3 tanTriplanarNormal314 = mul( ase_worldToTangent, triplanar314 );
			...
			float3 lerpResult31 = lerp( float3( 0,0,0 ) , tanTriplanarNormal314 , clampResult23);
			float temp_output_308_0 = ( 1.0 / _Texture2Tilling );
			float3 triplanar316 = TriplanarSamplingSNF( _Normal1, ase_worldPos, ase_worldNormal, _TriplanarFallOff, temp_output_308_0, _Normal2Power, 0 );
			float3 tanTriplanarNormal316 = mul( ase_worldToTangent, triplanar316 );
			float3 lerpResult32 = lerp( lerpResult31 , tanTriplanarNormal316 , Splat_1_G7);
			float temp_output_310_0 = ( 1.0 / _Texture3Tilling );
			float3 triplanar317 = TriplanarSamplingSNF( _Normal2, ase_worldPos, ase_worldNormal, _TriplanarFallOff, temp_output_310_0, _Normal3Power, 0 );
			float3 tanTriplanarNormal317 = mul( ase_worldToTangent, triplanar317 );
			half Splat_1_B8 = tex2DNode4.b;
			float3 lerpResult33 = lerp( lerpResult32 , tanTriplanarNormal317 , Splat_1_B8);
			float temp_output_313_0 = ( 1.0 / _Texture4Tilling );
			float3 triplanar318 = TriplanarSamplingSNF( _Normal3, ase_worldPos, ase_worldNormal, _TriplanarFallOff, temp_output_313_0, _Normal4Power, 0 );
			float3 tanTriplanarNormal318 = mul( ase_worldToTangent, triplanar318 );
			half Splat_1_A9 = tex2DNode4.a;
			float3 lerpResult34 = lerp( lerpResult33 , tanTriplanarNormal318 , Splat_1_A9);
			...
			float4 triplanar306 = TriplanarSamplingSF( _Splat0, ase_worldPos, ase_worldNormal, _TriplanarFallOff, temp_output_307_0, 1.0, 0 );
			float4 lerpResult24 = lerp( float4( 0,0,0,0 ) , ( appendResult291 * triplanar306 ) , clampResult23);
			float4 appendResult295 = (float4(1.0 , 1.0 , 1.0 , _Smoothness1));
			float4 triplanar309 = TriplanarSamplingSF( _Splat1, ase_worldPos, ase_worldNormal, _TriplanarFallOff, temp_output_308_0, 1.0, 0 );
			float4 lerpResult25 = lerp( lerpResult24 , ( appendResult295 * triplanar309 ) , Splat_1_G7);
			float4 appendResult299 = (float4(1.0 , 1.0 , 1.0 , _Smoothness2));
			float4 triplanar311 = TriplanarSamplingSF( _Splat2, ase_worldPos, ase_worldNormal, _TriplanarFallOff, temp_output_310_0, 1.0, 0 );
			float4 lerpResult26 = lerp( lerpResult25 , ( appendResult299 * triplanar311 ) , Splat_1_B8);
			float4 appendResult303 = (float4(1.0 , 1.0 , 1.0 , _Smoothness3));
			float4 triplanar312 = TriplanarSamplingSF( _Splat3, ase_worldPos, ase_worldNormal, _TriplanarFallOff, temp_output_313_0, 1.0, 0 );
			float4 lerpResult27 = lerp( lerpResult26 , ( appendResult303 * triplanar312 ) , Splat_1_A9);
